"""
Django settings for trp_assistant_bot project.
...
SECRET_KEY = 'd!l8olzgtjmylv=sqei8jl%#=*4o6gvk3ka-k1$%kemi+$5=h#'
...
WSGI_APPLICATION = 'trp_assistant_bot.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'topicatrm123A@'
