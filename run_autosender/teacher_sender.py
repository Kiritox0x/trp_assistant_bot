...
def SendMail(classroom, mail):	
	...
	#print (content_mail)
	send_mail(mail.subject, content_mail, "profpnlinh1207@gmail.com", [classroom.teacher.topica_email], fail_silently=False)
	#thay profpnlinh1207 bang domain address 
